    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Left: text */}
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/[0.03] text-sm text-gray-400 mb-8 backdrop-blur-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 animate-pulse" />
              Подготовлено для Онлайн-школы №1
            </div>

            <h1 className="text-5xl md:text-7xl font-extrabold tracking-[-0.03em] leading-[1.05] text-white mb-6">
              Ваша команда<br />
              <span className="text-gradient">полюбит AI</span>
              {' '}<span className="inline-block animate-pulse">❤️</span>
            </h1>

            <p className="text-xl text-gray-400 leading-relaxed mb-10 max-w-lg tracking-[-0.01em]">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button
                ...
                className="group inline-flex items-center gap-3 px-8 py-4 rounded-full bg-cyan-500 text-black font-semibold text-lg transition-all duration-300 glow-button hover:bg-cyan-400"
              >
                Как это устроено
          ...
          <div className="relative flex items-center justify-center">
            ...
            {/* Main circle */}
            <div className="relative w-[320px] h-[320px] md:w-[380px] md:h-[380px] rounded-full border border-white/[0.08] bg-white/[0.02] backdrop-blur-sm flex items-center justify-center">
