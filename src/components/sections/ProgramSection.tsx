...
const modules: Module[] = [
  {
    ...
    deliverables: ['Было: рутина отнимает 2 часа в день → Стало: бот делает это за вас', 'Ваши промпты, проверенные педдизайнером — работают с первого раза', 'AI становится привычкой, а не экспериментом'],
  ...
  },
  {
    ...
    deliverables: ['Было: полдня на материалы → Стало: готовый комплект за 10 минут', 'Команда AI-агентов проверяет, правит и оформляет за вас', 'Педдизайнер проверяет результат — качество гарантировано'],
  ...
  },
  {
    ...
    deliverables: ['Было: ждать аналитика 2 дня → Стало: ответ с графиком за 30 секунд', 'Шаблоны отчётов, которые команда использует каждую неделю', 'С поддержкой ассистента: он подскажет, какой вопрос задать'],
  ...
  },
  {
    ...
    deliverables: ['Было: счета и акты вручную → Стало: AI заполняет за секунды', 'Рабочий прототип автоматизации — готов к запуску в первый день', 'Ассистент помогает выбрать, что автоматизировать первым'],
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="mb-10 max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/25">
            <span className="text-sm text-blue-400 font-medium">↓ Пример плана — адаптируется под вас после аудита</span>
          </div>
        </div>
